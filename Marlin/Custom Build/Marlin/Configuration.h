...
#define Y_DRIVER_TYPE  TMC2208_STANALONE
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.36   // Z offset: -below +above  [the nozzle]
...
#define X_MIN_POS -4.2
#define Y_MIN_POS -12.5
#define Z_MIN_POS 0
